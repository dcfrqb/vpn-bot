...
from app.domain.texts.common import BTN_ARTICLE, BTN_SUBSCRIPTION, BTN_TRIAL
...
def error(support_handle: Optional[str] = None) -> tuple[str, InlineKeyboardMarkup]:
    rows = [[btn(BTN_SUBSCRIPTION, Nav(s="plans"))], support_row(support_handle), back_to_main_row()]
