...
WHITELIST_FILES = {
    ...
    "src/app/routers/crypto_payments.py": [
        ...
        "команда",  # Команды бота
        "справка",  # Справка по использованию
        "список",  # Списки платежей
        "подтверждение",  # Подтверждение платежей
        "отклонение",  # Отклонение платежей
        "парсинга",  # Ошибки парсинга
        "конфигурации",  # Ошибки конфигурации
    ],
